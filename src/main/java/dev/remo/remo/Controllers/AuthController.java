...
public class AuthController {
         ...
         * // If the email does not exist in the system, it means the registration
         * failed.
         ...
         * if (userService.checkByEmail(request.getEmail())) {
         * // If the email still exists in the system after a failed registration, it
         * means the postcondition has failed,
